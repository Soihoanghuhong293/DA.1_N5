            ...
            <form action="<?= BASE_URL_ADMIN . '?act=them-san-pham' ?>" method="POST" enctype="multipart/form-data">
              <div class="row card-body ">
                ...
                <div class="form-group col-6">
                  ...
                  <input type="number" class="form-control" name="gia_khuyen_mai" placeholder="Nhập giá khuyến phẩm">
                ...
                <div class="form-group col-6">
                  ...
                  <input type="number" class="form-control" name="so_luong" placeholder="Nhập số lường sản phẩm">
                ...
                <div class="form-group col-6">
                  ...
                  <input type="date" class="form-control" name="ngay_nhap" placeholder="Ngày nhập sản phẩm">
